...
namespace MovementSystem
{
    public class PlayerGroundedState : PlayerMovementState
    {
        ...
        public override void Enter()
        {
            ...
            UpdateCaremaRecenteringState(stateMachine.ReusableData.MovementInput);
        }
        ...
        protected override void OnContactWithGroundExited(Collider collider)
        {
            ...
            Vector3 capsuleColliderCenterInWorldSpace = stateMachine.Player.ColliderUtility.CapsuleColliderData.Collider.bounds.center;
            Ray downwardsRayFromCapsuleBottom = new Ray(capsuleColliderCenterInWorldSpace - stateMachine.Player.ColliderUtility.CapsuleColliderData.ColliderVerticalExtends, Vector3.down);
